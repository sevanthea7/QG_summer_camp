...
from LSTM_hyper_parameters import train_data_path
from LSTM_load_dataset import tokenlize
import numpy as np
from LSTM_hyper_parameters import max_features
...
if __name__ == '__main__':
    ...
    # 保存词表
    np.save("../data/aclImdb_trans.npy", trans)             # 保存为 numpy.ndarray 的形式
    np.save("../data/aclImdb_intrans.npy", inverse_trans)
