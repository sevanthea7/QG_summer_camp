...
def main():
    ...
    r_turn_after = np.array([ [ r_turn + r_gap, r_turn ],
                     [ 2 * r_turn, r_middle ],
                     [ r_turn - 3 * r_gap, r_right - r_turn ] ])
    ...
    # 创建车辆信息
    xL_leader, xL, vL, vLL, rLeaderL, AL = create_vehicles( starting_direction, xL, vL, r_left, rL, L, r )
    xM_leader, xM, vM, vLM, rLeaderM, AM = create_vehicles( starting_direction, xM, vM, r_middle, rL, M, r )
    xR_leader, xR, vR, vLR, rLeaderR, AR = create_vehicles( starting_direction, xR, vR, r_right, rL, R, r )
    ...
    nLposV, nLvelV, nLposL, nLnt = update_data( kL, L, xL_leader, xL, vLL, vL, b, g, a, t, AL, r, rLt,  'L', r_turn_after[0] )
    print( '1' )
    ...
    xM = MposV[-1]
    vM = MvelV[-1]
    nMposV, nMvelV, nMposL, nMnt = update_data( kM, M, xM_leader, xM, vLM, vM, b, g, a, t, AM, r, rL, 'M', r_turn_after[1] )
    print( '2' )
    ...
    vLRt = -vLR
    rLtt = -rLt
    nRposV, nRvelV, nRposL, nRnt = update_data( kR, R, xR_leader, xR, vLRt, vR, b, g, a, t, AR, r, rLtt, 'R', r_turn_after[2] )
    print( '3' )
    ...
    LposV2, MposV2, RposV2, L2, M2, R2 = run()
